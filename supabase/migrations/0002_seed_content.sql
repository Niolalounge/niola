...
from (values
    ...
    ('hot-drinks', 'koshary-tea', 'شاي كشري', 'Koshary Tea', 45, null, null, null, 0, false),
    ('hot-drinks', 'lipton-tea', 'شاي ليبتون', 'Lipton Tea', 45, '/images/tea/liption tea.png', 1402, 1122, 1, true),
    ('hot-drinks', 'mint-tea', 'شاي نعناع', 'Mint Tea', 45, '/images/tea/mint tea.png', 1402, 1122, 2, true),
    ('hot-drinks', 'green-tea', 'شاي أخضر', 'Green Tea', 50, '/images/tea/green tea.png', 1402, 1122, 3, true),
    ('hot-drinks', 'karak-tea', 'شاي كرك', 'Karak Tea', 70, '/images/tea/krak tea.png', 1402, 1122, 4, true),
    ('hot-drinks', 'lemon-ginger-tea', 'شاي ليمون مع زنجبيل', 'Lemon Ginger Tea', 55, '/images/tea/lemon and ginger tea.png', 1402, 1122, 5, true),
    ('hot-drinks', 'lemon-tea', 'شاي ليمون', 'Lemon Tea', 55, null, null, null, 6, false),
    ('hot-drinks', 'red-tea-pot', 'براد شاي أحمر', 'Red Tea Pot', 150, '/images/tea/red tea.png', 1400, 1123, 7, false),
    ('hot-drinks', 'karak-tea-pot', 'براد شاي كرك', 'Karak Tea Pot', 200, null, null, null, 8, false),
    ('hot-drinks', 'hot-cider', 'هوت سيدر', 'Hot Cider', 80, '/images/hot drinks/Hot Cider.png', 1254, 1254, 9, true),
    ('hot-drinks', 'hot-chocolate', 'هوت شوكليت', 'Hot Chocolate', 130, '/images/hot drinks/Hot Chocolate.png', 1402, 1122, 10, true),
    ('hot-drinks', 'hot-tiramisu', 'هوت تيراميسو', 'Hot Tiramisu', 150, '/images/hot drinks/Hot Tiramisu.png', 1448, 1086, 11, true),
    ('hot-drinks', 'anise', 'يانسون', 'Anise', 45, '/images/hot drinks/Anise.png', 1254, 1254, 12, true),
    ('hot-drinks', 'sahlab', 'سحلب', 'Sahlab', 130, '/images/hot drinks/Sahlab.png', 1254, 1254, 13, true),
    ('hot-drinks', 'special-sahlab', 'سحلب سبيشل', 'Special Sahlab', 150, '/images/hot drinks/Special Sahlab.png', 1254, 1254, 14, true),
